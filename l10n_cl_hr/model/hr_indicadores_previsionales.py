...
class hr_indicadores_previsionales(models.Model):
    ...
    def update_document(self):
        ...
        try:
            ...
            self.tope_imponible_seguro_cesantia = string_divide(clear_string(letters[3].select("strong")[3].get_text()),
                                                                self.uf, 2)
            ...
            self.tope_mensual_apv = string_divide(clear_string(letters[5].select("strong")[2].get_text()), self.uf, 2)
            self.tope_anual_apv = string_divide(clear_string(letters[5].select("strong")[1].get_text()), self.uf, 2)
